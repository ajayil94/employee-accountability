...
//        'brandUrl' => Yii::$app->homeUrl,
            ...
            echo Nav::widget([
                ...
                'items' => [
                    ...
                    ['label' => 'Employees', 'url' => \yii\helpers\Url::to(['/employee/employee-master/index'])],
               ...
               // ['label' => 'Signup', 'url' => \yii\helpers\Url::to(['/users/users/index'])],
...
//            ['label' => 'Contact', 'url' => ['/site/contact']],
        ...
        <footer class="footer">
            <div class="container">
                <p class="pull-left">&copy; Employee Accountability <?= date('Y') ?></p>
